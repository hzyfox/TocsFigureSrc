...
set key left font ",28" at -1.6,180

plot 'kmeans-cache.dat' using 2:xticlabels(1) title columnheader(2), \
     '' using 3:xticlabels(1) title columnheader(3),\
	 ''using 4:xticlabels(1) title columnheader(4),\
	 'kmeans-time.dat' using ($2/1000.0):xticlabels(1) w lp pt 5 ps 3 lw 2 lc 6 axis x1y2 title columnheader(2), \
