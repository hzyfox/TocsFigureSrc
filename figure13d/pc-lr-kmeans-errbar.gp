...
plot 'pc-lr-kmeans-cache-errbar.dat' using 3:4:xticlabels(2) title columnheader(3), \
	 ...
	 'pc-lr-kmeans-time-errbar.dat' using 1:($3/100):4:xticlabels(2) w yerrorlines pt 5 ps 1 lw 2 lc 6 axis x1y2 title columnheader(3), \
	 '' using 1:($5/100):6:xticlabels(2) w yerrorlines pt 7 ps 1 lw 2 lc 7 axis x1y2 title columnheader(5),\
	 '' using 1:($7/100):8:xticlabels(2) w yerrorlines pt 9 ps 1 lw 2 lc 8 axis x1y2 title columnheader(7)
unset key
unset border
unset multiplot
